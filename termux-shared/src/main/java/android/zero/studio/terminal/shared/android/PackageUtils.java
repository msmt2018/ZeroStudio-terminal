package android.zero.studio.terminal.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/android.zero.studio.terminal.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx android.zero.studio.terminal/10xxx}
             */

package android.zero.studio.terminal.shared.activities;
 ...
 * {@code `<activity android:name="android.zero.studio.terminal.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="android.zero.studio.terminal.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }

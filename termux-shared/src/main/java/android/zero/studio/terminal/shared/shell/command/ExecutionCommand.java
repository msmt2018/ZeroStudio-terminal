package android.zero.studio.terminal.shared.shell.command;
...
public class ExecutionCommand {
    ...
    */
     ...
     * commands. By default, @link android.zero.studio.terminal.shared.shell.StreamGobbler} only logs stdout and

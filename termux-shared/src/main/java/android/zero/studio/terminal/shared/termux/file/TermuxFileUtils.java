package android.zero.studio.terminal.shared.termux.file;

import static android.zero.studio.terminal.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
...
import android.zero.studio.terminal.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/android.zero.studio.terminal` as secondary user will result
     * in `ls: /data/user/0/android.zero.studio.terminal: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/android.zero.studio.terminal` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/android.zero.studio.terminal` where `10` is

...
import android.zero.studio.terminal.shared.reflection.ReflectionUtils;
...
import android.zero.studio.terminal.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `android.zero.studio.terminal`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... android.zero.studio.terminal/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="android.zero.studio.terminal" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(android.zero.studio.terminal.shared.R.raw.apt_info_script);
        try {

package android.zero.studio.terminal.shared.termux.plugins;
...
import android.zero.studio.terminal.shared.R;
...
import android.zero.studio.terminal.shared.termux.file.TermuxFileUtils;
import android.zero.studio.terminal.shared.shell.command.result.ResultConfig;
import android.zero.studio.terminal.shared.shell.command.result.ResultData;
import android.zero.studio.terminal.shared.errors.Errno;
import android.zero.studio.terminal.shared.errors.Error;
import android.zero.studio.terminal.shared.notification.NotificationUtils;
import android.zero.studio.terminal.shared.termux.models.UserAction;
import android.zero.studio.terminal.shared.termux.notification.TermuxNotificationUtils;
import android.zero.studio.terminal.shared.termux.settings.preferences.TermuxPreferenceConstants;
import android.zero.studio.terminal.shared.shell.command.result.ResultSender;
...
import android.zero.studio.terminal.shared.termux.settings.preferences.TermuxPreferenceConstants.TERMUX_APP;
...
import android.zero.studio.terminal.shared.markdown.MarkdownUtils;

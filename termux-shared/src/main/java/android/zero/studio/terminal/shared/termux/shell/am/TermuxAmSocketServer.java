package android.zero.studio.terminal.shared.termux.shell.am;
...
import android.zero.studio.terminal.shared.net.socket.local.LocalClientSocket;
import android.zero.studio.terminal.shared.net.socket.local.LocalServerSocket;
import android.zero.studio.terminal.shared.net.socket.local.LocalSocketManager;
import android.zero.studio.terminal.shared.net.socket.local.LocalSocketManagerClientBase;
import android.zero.studio.terminal.shared.net.socket.local.LocalSocketRunConfig;
import android.zero.studio.terminal.shared.shell.am.AmSocketServerRunConfig;
import android.zero.studio.terminal.shared.shell.am.AmSocketServer;
...
import android.zero.studio.terminal.shared.termux.shell.command.environment.TermuxAppShellEnvironment;
 ...
 *
 * https://github.android.zero.studio.terminal/termux-am-socket
 * https://github.android.zero.studio.terminal/TermuxAm
 */

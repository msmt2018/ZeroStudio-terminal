...
import android.zero.studio.terminal.shared.termux.terminal.io.BellHandler;
import android.zero.studio.terminal.shared.logger.Logger;
import android.zero.studio.terminal.terminal.TerminalColors;
...
import android.zero.studio.terminal.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, android.zero.studio.terminal.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {android.zero.studio.terminal/android.zero.studio.terminal.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
